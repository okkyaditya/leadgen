        ...
        >
            ...
            <div className="space-y-6">
                <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-gray-800">
                    <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-4">Selamat Datang di Panduan Pengguna Lead Magnet</h3>
                    <p className="text-gray-600 dark:text-gray-400 mb-6 leading-relaxed">
                        Aplikasi Lead Magnet dirancang untuk mempermudah manajemen data prospek, pemantauan kinerja staf, dan pengelompokan data berdasarkan Cabang serta Mitra.
